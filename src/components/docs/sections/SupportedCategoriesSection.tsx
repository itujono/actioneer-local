...
export function SupportedCategoriesSection() {
  return (
    <section className="pt-12 mb-12" data-section="supported-categories">
      ...
      {/* Travel & Booking */}
      <div className="mb-10" data-section="travel-booking">
        <div className="bg-white rounded-lg border border-concrete overflow-hidden">
          <div className="bg-jade rounded-t-lg p-6 text-lime">
            <div className="flex items-center gap-3">
              <Plane className="h-8 w-8 text-white" />
              <h3 className="text-2xl font-bold">Travel & Booking</h3>
            </div>
          </div>
          <div className="p-6">
            <p className="text-gray mb-6">
              Imagine when you receive an email about "75% off hotels in NYC
              this weekend" or "Flash sale: flights to Tokyo starting at $299,"
              and instead of letting these deals get buried in your inbox,
              Actioneer automatically captures and organizes them into your
              travel dashboard.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray">
                  ...
                  <li>• Hotel reservations and accommodation bookings</li>
                  <li>• Travel attraction and tour bookings</li>
                  <li>• Transportation and car rental confirmations</li>
                  <li>• Travel-related receipts and itineraries</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-thunder mb-3">
                ...
                <ul className="space-y-2 text-sm text-gray">
                  ...
                  <li>• Hotel and attraction comparisons with pricing</li>
                  <li>
                    • Trip planning assistance with AI-powered suggestions
                  </li>
                  <li>• Calendar integration for travel dates</li>
                </ul>
              </div>
            </div>
          </div>
